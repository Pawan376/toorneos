			...
			<div className="px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto bg">
				        <div className="card2 card border-0 px-4 py-5 bg-light">
				                    ...
				                    <div className="row px-3"> <label className="mb-1">
				                        ...
				                        </label> <input className="mb-4" type="text" name="name" placeholder="Enter your first name"/> </div>
				                        <div className="row px-3"> <label className="mb-1">
				                            <h6 className="mb-0 text-sm">Last Name</h6>
				                        </label> <input className="mb-4" type="text" name="name" placeholder="Enter your last name"/> </div>
				                    <div className="row px-3"> <label className="mb-1">
				                    ...
				                    <div className="row mb-3 px-3"> <button type="submit" className="btn btn-blue text-center">Sign Up</button> </div>
